    ...
    Public Module DbBootstrap
        ...
        Private Sub EnsurePermissions()
            Dim permissions = {
                ...
                Tuple.Create("مغایرت بانکی – معرفی بانک‌ها", PermissionKeys.AccountingBankRecIntro),
                Tuple.Create("مغایرت بانکی – ورود صورت حساب بانک", PermissionKeys.AccountingBankRecImport),
                Tuple.Create("مغایرت بانکی – مغایرت‌گیری", PermissionKeys.AccountingBankRecMatch),
                Tuple.Create("مغایرت بانکی – پیشنهاد برای رفع مغایرت", PermissionKeys.AccountingBankRecSuggestions),
                ...
                Tuple.Create("سرفصل حسابها – ثبت جدید", PermissionKeys.AccountingHeaderNew),
                Tuple.Create("سرفصل حسابها – ویرایش", PermissionKeys.AccountingHeaderEdit),
                Tuple.Create("سرفصل حسابها – حذف", PermissionKeys.AccountingHeaderDelete),
                Tuple.Create("حسابهای شناور – ثبت جدید", PermissionKeys.AccountingShenavarNew),
                Tuple.Create("حسابهای شناور – ویرایش", PermissionKeys.AccountingShenavarEdit),
                Tuple.Create("حسابهای شناور – حذف", PermissionKeys.AccountingShenavarDelete),
                Tuple.Create("ثبت سند حسابداری – سند جدید", PermissionKeys.AccountingEntryNew),
                Tuple.Create("ثبت سند حسابداری – ویرایش", PermissionKeys.AccountingEntryEdit),
                Tuple.Create("ثبت سند حسابداری – حذف", PermissionKeys.AccountingEntryDelete),
                Tuple.Create("ثبت سند حسابداری – کپی سند", PermissionKeys.AccountingSanadCopy),
                Tuple.Create("ثبت سند حسابداری – ادغام سند", PermissionKeys.AccountingSanadMerge),
                Tuple.Create("ثبت سند حسابداری – تجزیه سند", PermissionKeys.AccountingSanadSplit),
                Tuple.Create("مغایرت بانکی – انتخاب فایل صورت حساب", PermissionKeys.AccountingBankRecSelectFile),
                Tuple.Create("مغایرت بانکی – ذخیره اطلاعات صورت حساب", PermissionKeys.AccountingBankRecSaveData),
                Tuple.Create("مغایرت بانکی – انتقال شرح صورت حساب به شرح ردیف دفتر", PermissionKeys.AccountingBankRecTransferDesc),
                Tuple.Create("مغایرت بانکی – گزارش صورتحساب بانکی", PermissionKeys.AccountingBankRecStatementReport),
                Tuple.Create("سود و زیان – ذخیره تنظیمات", PermissionKeys.AccountingProfitLossSaveSettings),
                Tuple.Create("سود و زیان – ویرایش تنظیمات", PermissionKeys.AccountingProfitLossEditSettings),
                Tuple.Create("سود و زیان – معرفی حسابها", PermissionKeys.AccountingProfitLossMapAccounts),
                Tuple.Create("سود و زیان – محاسبه و نمایش", PermissionKeys.AccountingProfitLossCalculate),
                Tuple.Create("ترازنامه – ذخیره تنظیمات", PermissionKeys.AccountingBalanceSheetSaveSettings),
                Tuple.Create("ترازنامه – ویرایش تنظیمات", PermissionKeys.AccountingBalanceSheetEditSettings),
                Tuple.Create("ترازنامه – معرفی حسابها", PermissionKeys.AccountingBalanceSheetMapAccounts),
                Tuple.Create("ترازنامه – محاسبه و نمایش", PermissionKeys.AccountingBalanceSheetCalculate),
                Tuple.Create("طراحی گزارشات دلخواه – ایجاد گزارش جدید", PermissionKeys.AccountingCustomReportNew),
                Tuple.Create("طراحی گزارشات دلخواه – ویرایش گزارش", PermissionKeys.AccountingCustomReportEdit),
                Tuple.Create("طراحی گزارشات دلخواه – حذف گزارش", PermissionKeys.AccountingCustomReportDelete),
                Tuple.Create("حسابداری – طراحی گزارش دلخواه – خروجی اکسل", PermissionKeys.AccountingCustomReportExport),
                Tuple.Create("گزارشات و ترازهای حسابداری ( منو )", PermissionKeys.AccountingReportsMenu),
                Tuple.Create("انبارداری مینی – فروش سریع", PermissionKeys.AnbarMiniPos),
                Tuple.Create("انبارداری مینی – فروش سریع – ثبت فاکتور جدید", PermissionKeys.AnbarMiniPosNew),
                Tuple.Create("انبارداری مینی – فروش سریع – ویرایش فاکتور", PermissionKeys.AnbarMiniPosEdit),
                Tuple.Create("انبارداری مینی – فروش سریع – حذف فاکتور", PermissionKeys.AnbarMiniPosDelete),
                Tuple.Create("انبارداری مینی – خرید کالا", PermissionKeys.AnbarMiniKharid),
                Tuple.Create("انبارداری مینی – خرید کالا – ثبت فاکتور جدید", PermissionKeys.AnbarMiniKharidNew),
                Tuple.Create("انبارداری مینی – خرید کالا – ویرایش فاکتور", PermissionKeys.AnbarMiniKharidEdit),
                Tuple.Create("انبارداری مینی – خرید کالا – حذف فاکتور", PermissionKeys.AnbarMiniKharidDelete),
                Tuple.Create("انبارداری مینی – لیست طرف حساب‌ها", PermissionKeys.AnbarMiniPersons),
                Tuple.Create("انبارداری مینی – لیست طرف حساب‌ها – ثبت شخص جدید", PermissionKeys.AnbarMiniPersonsNew),
                Tuple.Create("انبارداری مینی – لیست طرف حساب‌ها – ویرایش شخص", PermissionKeys.AnbarMiniPersonsEdit),
                Tuple.Create("انبارداری مینی – لیست طرف حساب‌ها – حذف شخص", PermissionKeys.AnbarMiniPersonsDelete),
                Tuple.Create("انبارداری مینی – لیست کالاها", PermissionKeys.AnbarMiniProducts),
                Tuple.Create("انبارداری مینی – لیست کالاها – کالای جدید", PermissionKeys.AnbarMiniProductsNew),
                Tuple.Create("انبارداری مینی – لیست کالاها – ویرایش کالا", PermissionKeys.AnbarMiniProductsEdit),
                Tuple.Create("انبارداری مینی – لیست کالاها – حذف کالا", PermissionKeys.AnbarMiniProductsDelete),
                Tuple.Create("انبارداری مینی – لیست انبارها", PermissionKeys.AnbarMiniWarehouses),
                Tuple.Create("انبارداری مینی – لیست انبارها – انبار جدید", PermissionKeys.AnbarMiniWarehousesNew),
                Tuple.Create("انبارداری مینی – لیست انبارها – ویرایش انبار", PermissionKeys.AnbarMiniWarehousesEdit),
                Tuple.Create("انبارداری مینی – لیست انبارها – حذف انبار", PermissionKeys.AnbarMiniWarehousesDelete),
                Tuple.Create("انبارداری مینی – دسته‌بندی کالا", PermissionKeys.AnbarMiniGroups),
                Tuple.Create("انبارداری مینی – دسته‌بندی کالا – جدید بالای فرم", PermissionKeys.AnbarMiniGroupsNewTop),
                Tuple.Create("انبارداری مینی – دسته‌بندی کالا – جدید", PermissionKeys.AnbarMiniGroupsNew),
                Tuple.Create("انبارداری مینی – دسته‌بندی کالا – ویرایش", PermissionKeys.AnbarMiniGroupsEdit),
                Tuple.Create("انبارداری مینی – دسته‌بندی کالا – حذف", PermissionKeys.AnbarMiniGroupsDelete),
                Tuple.Create("انبارداری مینی – گزارشات", PermissionKeys.AnbarMiniReports),
                Tuple.Create("انبارداری مینی – موجودی انبار", PermissionKeys.AnbarMiniInvStock),
                Tuple.Create("انبارداری مینی – موجودی انبار – چاپ", PermissionKeys.AnbarMiniInvStockPrint),
                Tuple.Create("انبارداری مینی – کاردکس کالا", PermissionKeys.AnbarMiniKardex),
                Tuple.Create("انبارداری مینی – کاردکس کالا – نمایش کاردکس", PermissionKeys.AnbarMiniKardexLoad),
                Tuple.Create("انبارداری مینی – کاردکس کالا – چاپ", PermissionKeys.AnbarMiniKardexPrint),
                Tuple.Create("انبارداری مینی – سود و زیان", PermissionKeys.AnbarMiniProfitLossRep),
                Tuple.Create("انبارداری مینی – سود و زیان – نمایش گزارش", PermissionKeys.AnbarMiniProfitLossLoad),
                Tuple.Create("انبارداری مینی – سود و زیان – چاپ عملکرد", PermissionKeys.AnbarMiniProfitLossPrintStatement),
                Tuple.Create("انبارداری مینی – سود و زیان – چاپ سود و زیان", PermissionKeys.AnbarMiniProfitLossPrintRep),
                Tuple.Create("انبارداری مینی – لیست انبارگردانی", PermissionKeys.AnbarMiniInventoryCount),
                Tuple.Create("انبارداری مینی – لیست انبارگردانی – تهیه لیست", PermissionKeys.AnbarMiniInventoryCountGenerate),
                Tuple.Create("انبارداری مینی – لیست انبارگردانی – چاپ", PermissionKeys.AnbarMiniInventoryCountPrint),
                Tuple.Create("انبارداری مینی – سامانه مودیان ساده (نوع ۲)", PermissionKeys.AnbarMiniModyan),
                Tuple.Create("انبارداری مینی – سامانه مودیان – ارسال سریع فاکتور", PermissionKeys.AnbarMiniModyanSend),
                Tuple.Create("انبارداری مینی – سامانه مودیان – مشاهده راهنما", PermissionKeys.AnbarMiniModyanGuide),
                Tuple.Create("انبارداری متوسط – سامانه مودیان پیشرفته", PermissionKeys.TradeModyanMedium),
                Tuple.Create("انبارداری پیشرفته – سامانه مودیان جامع", PermissionKeys.TradeModyanBig),
                Tuple.Create("سامانه مودیان – تنظیم کلیدها و حافظه مالیاتی", PermissionKeys.TradeModyanKeysSetup),
                Tuple.Create("سامانه مودیان – ارسال صورتحساب‌های رسمی به کارپوشه", PermissionKeys.TradeModyanSendInvoices),
                Tuple.Create("سامانه مودیان – استعلام وضعیت صورتحساب‌ها", PermissionKeys.TradeModyanInquiry),
                ...
                Tuple.Create("انبار مینی – ثبت هزینه جدید", PermissionKeys.AnbarMiniExpensesSave),
