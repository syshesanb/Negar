...
Namespace Negar.Forms
    ...
    Partial Class HesabdaryMainForm
        ...
        Friend WithEvents tabOtherReports As TabPage
        Friend WithEvents tabsOtherReports As TabControl
        ...
        Private Sub InitializeComponent()
            ...
            Me.tabOtherReports = New TabPage()
            Me.tabsOtherReports = New TabControl()
            ...
            Me.tabOtherReports.SuspendLayout()
            Me.tabsOtherReports.SuspendLayout()
            ...
            Me.tabSettings.Size = New Size(1312, 722)
            Me.tabSettings.Text = "تنظیمات اولیه حسابها"
            ...
            ' tabOtherReports
            '
            Me.tabOtherReports.Location = New Point(4, 23)
            Me.tabOtherReports.Name = "tabOtherReports"
            Me.tabOtherReports.Padding = New Padding(3)
            Me.tabOtherReports.Size = New Size(1312, 722)
            Me.tabOtherReports.Text = "سایر گزارشات"
            Me.tabOtherReports.UseVisualStyleBackColor = True
            '
            ' tabsOtherReports
            '
            Me.tabsOtherReports.Dock = DockStyle.Fill
            Me.tabsOtherReports.Location = New Point(3, 3)
            Me.tabsOtherReports.Name = "tabsOtherReports"
            Me.tabsOtherReports.RightToLeftLayout = True
            Me.tabsOtherReports.SelectedIndex = 0
            Me.tabsOtherReports.Size = New Size(1306, 716)
            Me.tabsOtherReports.TabIndex = 0
            '
            ' tabAdvancedReports
            '
            ...
            Me.tabs.Controls.Add(Me.tabOtherReports)
            Me.tabOtherReports.Controls.Add(Me.tabsOtherReports)
            Me.tabsOtherReports.Controls.Add(Me.tabAdvancedReports)
            Me.tabsOtherReports.Controls.Add(Me.tabChartReports)
            Me.tabsOtherReports.Controls.Add(Me.tabReports)
            ...
            Me.tabsOtherReports.ResumeLayout(False)
            Me.tabOtherReports.ResumeLayout(False)
