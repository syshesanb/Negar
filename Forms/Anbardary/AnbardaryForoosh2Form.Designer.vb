...
Namespace Sys_Hes_Anb.Forms
    ...
    Partial Class AnbardaryForoosh2Form
        ...
        Private Sub InitializeComponent()
            ...
            'topPanel
            '
            Me.topPanel.BackColor = Color.FromArgb(250, 235, 240)
            ...
            Me.grpAddProduct.Text = "افزودن کالا به پیش‌فاکتور / فروش"
            '
            'lblProduct
            '
            ...
            'bottomPanel
            '
            Me.bottomPanel.BackColor = Color.FromArgb(250, 235, 240)
            ...
            Me.lblTotal.ForeColor = Color.FromArgb(160, 30, 80)
            ...
            Me.Text = "ثبت / ویرایش فاکتور فروش"
