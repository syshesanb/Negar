    ...
    Public Class AnbardaryForoosh1Form
        ...
        Private Sub AnbardaryForoosh1Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            ...
            If Me.dgvInvoices IsNot Nothing Then
                Me.dgvInvoices.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(255, 242, 248)
            End If
        ...
        Private Sub ConfigureGrid()
            ...
            colCustomer.HeaderText = "خریدار"
            colCustomer.FillWeight = 30
            ...
            dgvInvoices.Columns.AddRange(New DataGridViewColumn() {colId, colNum, colDate, colCustomer, colTotal})
        End Sub
        ...
        Private Sub BtnNew_Click(sender As Object, e As EventArgs) Handles btnNew.Click
            Using frm As New AnbardaryForoosh2Form()
        ...
        Private Sub OpenSelectedForEdit()
            ...
            Using frm As New AnbardaryForoosh2Form(invoiceId)
                If frm.ShowDialog() = DialogResult.OK Then
                    LoadData()
                End If
            End Using
        ...
        Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
            ...
            Dim confirm = MessageBox.Show("آیا از حذف فاکتور فروش شماره «" & invoiceNum & "» و بازگرداندن موجودی انبار اطمینان دارید؟",
            ...
            If confirm = DialogResult.Yes Then
                Try
                    ...
                    MessageBox.Show("فاکتور فروش با موفقیت حذف شد.", "موفقیت", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    LoadData()
                Catch ex As Exception
        ...
        Private Sub TxtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged
            ...
            Else
                _invoicesTable.DefaultView.RowFilter = String.Format(
                    "InvoiceNumber LIKE '%{0}%' OR CustomerName LIKE '%{0}%' OR PersianDate LIKE '%{0}%'", kw)
            End If
        End Sub
    End Class
End Namespace
